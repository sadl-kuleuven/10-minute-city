...
piscines <- st_read("J:/SET-SADL_User-DI0222/Projecten/Brussel-10-min/04 Model/Processing/1. DataPreparation/ALLData (tree)/Vivre ensemble & Bien-être/Soins de santé/Equipements-services/Urgences.shp")
...
st_write(Isochrones_ALL, dsn = destination, layer = "Hopital 9", driver = "ESRI Shapefile", append = F, overwrite=T)
