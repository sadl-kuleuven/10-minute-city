...
piscines <- st_read("J:/SET-SADL_User-DI0222/Projecten/Brussel-10-min/04 Model/Processing/1. DataPreparation/piscines extracted.shp")
...
st_write(Isochrones_ALL, dsn = destination, layer = "Piscine 8", driver = "ESRI Shapefile", append = F, overwrite=T)
